    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="p-10 rounded-[30px] border border-white/10 bg-[#111827]/70 backdrop-blur-xl text-center">
          ...
          {/* AVATAR */}
          <div className="w-36 h-36 rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 flex items-center justify-center text-3xl md:text-6xl font-black mx-auto">
          ...
          <button
            ...
            className="mt-8 px-8 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 hover:scale-105 transition-all duration-300 font-bold text-slate-900"
          >
